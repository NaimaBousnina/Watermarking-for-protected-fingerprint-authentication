...
gradient_sq_minus_value = zeros(w,h);%trouver le lears quare approximation 
gradient_for_bg_under = zeros(w,h);  %background
...
for i=1:W:w
    for j=1:W:h
      if j+W-1 < h & i+W-1 < w
          ...
          if sum_value ~= 0 & times_value ~=0 %%% Extraire les bocks avec moin pertinance au niveau le ridge at furrow
